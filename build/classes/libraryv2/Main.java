            ...
            switch (choice) 
            {
                ...
                case 3:
                    if(this.itemStore != null)
                    {
                        ...
                        itemStore.storeData("Items3.csv");
    ...
    private void addItem()
    {
        ...
        do {
            ...
            if(category.equalsIgnoreCase("Book"))
            {
                ...
                bAdded = itemStore.add(new Book(id, category,title,genre,releaseYear,rating,author,publisher,pageCount));
            }
            else if(category.equalsIgnoreCase("Movie"))
            {
                ...
                bAdded = itemStore.add(new Movie(id,category,title,genre,releaseYear,rating,director,budget,length));
            }
            else
            {
                bAdded = false;
    ...
    ***************************************************************************/
    ...
    {      
        ...
        {                  
            ...
            //int idCount = (Integer.parseInt(stringTokenizer.nextElement().toString()));
